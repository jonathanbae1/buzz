...
export type OmpProfileState = "configured" | "unavailable" | "invalid";

export type OmpProfileSelectionOrigin =
  | "recordEnv"
  | "personaEnv"
  | "globalEnv"
  | "harnessEnv"
...
export type OmpProfileUnavailableReason =
  | "manifestMissing"
  | "manifestUnreadable"
  | "manifestInvalid"
  | "selectorConflict"
...
export type OmpProfileSurface = {
  state: OmpProfileState;
  selectedName: string | null;
  selectionOrigin: OmpProfileSelectionOrigin | null;
...
export type RuntimeConfigSurface = {
  ...
  currentMode?: string;
  /** Installer-owned, read-only omp profile declaration and effective selector. */
  ompProfile?: OmpProfileSurface;
};
